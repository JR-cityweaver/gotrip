...
<div class="header">
    <div class="clearfix w1200">
        <ol class="head-nav fl">
            <li class="logo"><a href="<%=path%>/home.jsp"><img src="./hotelPay_files/logo.png" style="width:62px;height:50px;"></a></li>
        ...
        <div class="order-detail ">
            <div class="pay-btn clearfix">
                <p class="pay-money fl">
                    <i>应付金额</i>
                    <span><b>￥</b>${hotelOrder.hotelorder_price}</span>
                </p>
            ...
            <ul class="detail-inner clearfix">
                <li>
                    <i>订单号：</i>
                    <span class="order-num">${hotelOrder.hotelorder_number}</span>
                </li>
                <li>
                    <i>产品名称：</i>
                    <span class="hotel-name">${hotelOrder.hotelorder_name}</span>
                </li>
                <li>
                    <i>入住时间：</i>
                    <span class="occu-time">${hotelOrder.hotelorder_intime}至${hotelOrder.hotelorder_outtime}</span>
                </li>
            </ul>
        </div>
<form name="myForm" id="myForm" target="_blank" action="" method="post">
    ...
    <div class="pay-toggle main_tab">
    	<div class="tab_1 tab clearfix">
    		<b style="font-size: 20px">支付完成!             看一下其他酒店</b>
    		<div style="height: 20px"></div>
    		<div class="hotel-inner-img" style="display: inline-block;">
				<img style="width: 350px;height: 200px" data-original="http://image.goutrip.com/42/2d9f95eda068985f55cb7a47d2dbe8.jpg" src="http://www.goutrip.com/hotel/channel.html" alt="" onclick="window.location.href=&#39;<%=path%>/hotelInfo.do?hotel_id=1&#39;">
				<p>
				    <b class="toggle-img-title" style="display: inline-block;">苏州长江智选假日酒店</b>
					<span class="toggle-img-parice" style="display: inline-block;float: right;"><i>￥350</i> 起</span>
				</p>
			</div>
			<div style="display: inline-block;width: 40px;height: 200px"></div>
			<div class="hotel-inner-img" style="display: inline-block;">
				<img style="width: 350px;height: 200px" class="bgImage" data-original="http://image.goutrip.com/de/1d108d452e9cb9408db6c21bdb9e35.jpg" src="http://www.goutrip.com/hotel/channel.html" alt="" onclick="window.location.href=&#39;<%=path%>/hotelInfo.do?hotel_id=2&#39;">
				<p>
				    <b class="toggle-img-title" style="display: inline-block;">厦门山水丽景大酒店</b>
					<span class="toggle-img-parice" style="display: inline-block;float: right;"><i>￥469</i> 起</span>
				</p>
			</div>
			<div style="display: inline-block;width: 40px;height: 200px"></div>
			<div class="hotel-inner-img" style="display: inline-block;">
				<img style="width: 350px;height: 200px" class="bgImage" data-original="http://image.goutrip.com/ab/8e98d2ca07c75e36d3a2d8a6b7579d.jpg" src="http://www.goutrip.com/hotel/channel.html" alt="" onclick="window.location.href=&#39;<%=path%>/hotelInfo.do?hotel_id=2&#39;">
				<p>
				    <b class="toggle-img-title" style="display: inline-block;">杭州第一世界大酒店</b>
					<span class="toggle-img-parice" style="display: inline-block;float: right;"><i>￥871</i> 起</span>
				</p>
			</div>
    	</div>
   	</div>
...
function subForm(i){
	...
	if(i==1){
		myForm.action="<%=path%>/hotelalipay.jsp?num=${hotelOrder.hotelorder_number}&name=${hotelOrder.hotelorder_name}&price=${hotelOrder.hotelorder_price}";
		myForm.submit();
		//myForm为form的id
	}else if(i==3){
		myForm.action="<%=path%>/hotelalipay.jsp?num=${hotelOrder.hotelorder_number}&name=${hotelOrder.hotelorder_name}&price=${hotelOrder.hotelorder_price}";//银联接口
		myForm.submit();
		//myForm为form的id
	}else{
		myForm.action="<%=path%>/hotelalipay.jsp?num=${hotelOrder.hotelorder_number}&name=${hotelOrder.hotelorder_name}&price=${hotelOrder.hotelorder_price}";//支付宝接口
		myForm.submit();
		//myForm为form的id
	}
}

   ...
   <form action="<%=path%>/search.do?pageNo=${pageNo}" method="post">
    <div class="search-bar clearfix">
        <p class="search-address fl">
            <span>目的地</span>
            <input type="text" id="city" name="city" placeholder="请输入目的地" onfocus="this.style.color=&#39;#666&#39;" onkeydown="this.style.color=&#39;#666&#39;">
        </p>
    ...
    <div class="hotel-type clearfix">
        ...
        <input type="hidden" id="hotel_label" value="${label}">
        <ul class="type-list fl">
            ...
            <li label="villa"><a href="<%=path %>/hoteltype.do?hotel_type=5&type=villa">别墅庄园</a></li>
    ...
    <div class="main-content">
        ...
        <%-- <form action="<%=path%>/hotelInfo.do?hotel_id=${list.hotel_id}" method="post"> --%>
        <!--酒店内容&#45;&#45;&#45;&#45;详情-->
		        <div class="content-inner clearfix">
		            <p class="inner-title"><i class="font-c">HOTEL</i>${list.hotel_name}</p>
		            ...
		            <div class="summary fr">
		                ...
		                <div class="summ-txt">
		                <p class="sum-inner" style="line-height: 0;"></p>${list.hotel_introduce}<p style="line-height: 0;"></p>
		                </div>
		                ...
		                <div class="sum-parice">
		                    <p class="parice-detail">
		                        <span class="">
		                            <i class="parice">${list.hotel_price}</i>元起/晚
		                        </span>
		                        
		                        <input type="button" class="detail" value="查看详情" onclick="window.location.href=&#39;<%=path%>/hotelInfo.do?hotel_id=${list.hotel_id}&#39;">
		                    </p>
...
<div class="cont_botm_nav clearfix">
	<div>
	  <form action="<%=path%>/list.do?pageNo=pageNum" method="post">
		<p>
		    ...
		    <ul style="display:inline-block; list-style: none;" id="page_ul">
				...
				<c:if test="${pageNo >1}">
					 <li><span class="bgc"><a href="<%=path%>/list.do?pageNo=${pageNo-1}">上一页</a></span></li>
				</c:if>
				<c:forEach var="item" begin="1" end="${page}" step="1">
					 <c:choose>
					    ...
					    <c:otherwise>
					    	<li><span class="bgc"><a href="<%=path%>/list.do?pageNo=${item}">${item}</a></span></li>
					    </c:otherwise>
					 </c:choose>
				</c:forEach>
				<c:if test="${pageNo < page}">
					<li><span class="bgc"><a href="<%=path%>/list.do?pageNo=${pageNo+1}">下一页</a></span></li>
				</c:if>
				<c:if test="${pageNo >= page}">
		   ...
		   <p>
		    	<span>到</span><input type="text" class="stage_page_in" name="${pageNo}"><span>页</span>

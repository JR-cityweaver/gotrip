                 	   ...
                 	   <c:forEach items="${orderList}" var="orderList">
	                     <ol>
					        ...
					        <li>
					        	...
					        	<a href="<%=basePath%>/hotel_iframe/hotelPay.jsp?number=${orderList.hotelorder_number}&price=${orderList.hotelorder_price}&name=${orderList.hotelorder_name}&intime=${orderList.hotelorder_intime}&outtime=${orderList.hotelorder_outtime}" target="_blank">去付款</a>
					        	<a onclick="nopay()" href="<%=basePath%>/deletenopay.do?hotelorder_id=${orderList.hotelorder_id}">不想去了</a>
					        </li>
					      </ol>
						</c:forEach>

...
<!DOCTYPE html>
<!-- saved from url=(0074)http://www.goutrip.com/themeTrip/searchResultList.html?keyword=anlu&sort=5 -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="renderer" content="webkit">
    <title>搜索列表</title>
    <link rel="stylesheet" href="<%=basePath%>/miss/public.css">
    <link rel="stylesheet" href="<%=basePath%>/miss/common.css">
    <link rel="stylesheet" href="<%=basePath%>/miss/searchList.css">
    <link rel="shortcut icon" type="image/x-icon" href="http://www.goutrip.com/images_new/favicon.ico">
    <script src="<%=basePath%>/miss/hm.js.下载"></script><script src="<%=basePath%>/miss/jquery-1.11.3.js.下载"></script>
    <script src="<%=basePath%>/miss/layer.js.下载"></script><link rel="stylesheet" href="<%=basePath%>/miss/layer.css" id="layui_layer_skinlayercss">
</head>
<body>
<!--头部开始-->
<!--顶部导航开始-->
...
<!--意见反馈开始-->
		...
		<!--意见反馈结束-->
<script src="<%=basePath%>/miss/jquery.lazyload.min.js.下载"></script><!--懒加载图片-->
...
<div class="body">
    ...
    <div>
        ...
        <input type="hidden" id="sortType" value="5">
    </div>
    <div class="container">
    	<!--遍历每一块内容开始-->
			<img src="<%=basePath%>/miss/notfound.png" style="max-width:100%">
    </div>
    <!--翻页开始-->
<script type="text/javascript">
...
<div class="jian">
    <p></p>
    <img src="<%=basePath%>/miss/cap_07.png">
    <span>推荐</span>
    <p></p>
</div>
...
<div class="midd-botm">
    <div>
	        <div>
	            <div>
	                <a href="http://www.goutrip.com/route/2357.html" target="_blank">
	                	<img class="bgImage" alt="【酷爽冲浪】马尔代夫图鲁斯杜Thulusdhoo岛冲浪3晚4天" src="<%=basePath%>/miss/4fa506e7ca62405e667185caea6712.jpg">
		            </a>
	            ...
	            <div>
	                <p><a href="http://www.goutrip.com/route/2357.html" target="_blank"> 【酷爽冲浪】马尔代夫图鲁斯杜Thulusdhoo岛冲浪3晚4天</a></p>
	                <p><a href="http://www.goutrip.com/route/2357.html" target="_blank">椰林树影，水清沙幼，在人间天堂的至美景色下，与蓝色海浪一起翻滚，跳跃，捉迷藏。</a></p>
	            </div>
	        </div>
	        <div>
	            <div>
	                <a href="http://www.goutrip.com/route/2363.html" target="_blank">
	                	<img class="bgImage" alt="【浓情蜜月】巴厘岛海外婚礼5晚6日" src="<%=basePath%>/miss/d880b066c2a9f5e6d73b34819a32ba.jpg">
		            </a>
	            ...
	            <div>
	                <p><a href="http://www.goutrip.com/route/2363.html" target="_blank"> 【浓情蜜月】巴厘岛海外婚礼5晚6日</a></p>
	                <p><a href="http://www.goutrip.com/route/2363.html" target="_blank">一句 I Do，表达心中神圣的那份爱意；一场婚礼，给最爱的Ta一份甜蜜的回忆</a></p>
	            </div>
	        </div>
	        <div>
	            <div>
	                <a href="http://www.goutrip.com/route/2365.html" target="_blank">
	                	<img class="bgImage" alt="【酷爽冲浪】日本湘南自由冲浪4晚5日游" src="<%=basePath%>/miss/1486784b27a990f817b3be99da662a.jpg">
		            </a>
	            ...
	            <div>
	                <p><a href="http://www.goutrip.com/route/2365.html" target="_blank"> 【酷爽冲浪】日本湘南自由冲浪4晚5日游</a></p>
	                <p><a href="http://www.goutrip.com/route/2365.html" target="_blank">带上冲浪板，让海浪与我们一起大笔勾勒 No Surf，No Life ！</a></p>
	            </div>
	        </div>
    </div>
</div>
...
<aside class="asides" style="display: none;">
    <ul>
        <li class="app">
            ...
            <!--二维码-->
            <div class="appEr"><img src="<%=basePath%>/miss/apper.png" alt=""></div>
        </li>
        <li class="phone">
            <a href="javascript:;"></a>
...
<div class="botm" data-oxlazy="<%=basePath%>/image/bgmidd_04.png">
    <div class="w1200">
        ...
        <div>
            <img src="<%=basePath%>/miss/bannner_34.png">
            <p>够旅游微信公众号</p>
        </div>

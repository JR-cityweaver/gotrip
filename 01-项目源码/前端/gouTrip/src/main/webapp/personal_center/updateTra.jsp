...
<body>
        ...
        <form action="<%=basePath%>/updateTra.do?traveller_id=${param.traveller_id}" method="post" name="reg_testdate">
                                <input type="hidden" id="friend_id" name="friendId">
                                <ul class="addPassager" id="addPassager">
                                    <li class="clearfix">
                                        <p><i>*</i>&nbsp;姓名：</p>
                                        <input type="text" name="traveller_name" id="friend_name" value="${param.name}" required="required">
                                    </li>
                                    <li class="clearfix">
                                        <p>性别：</p>
                                        <div class="sex">
                                    ...
                                    <li class="clearfix">
                                        <p><i>*</i>&nbsp;手机号码：</p>
                                        <input type="text" name="traveller_phone" id="friend_phone" value="${param.phone}" required="required">
                                    </li>
                                    <li class="clearfix">
                                        <p>邮箱：</p>
                                        <input type="text" name="traveller_mail" value="${param.email}" id="friend_email">
                                    </li>
                                    <li class="clearfix" id="cardLi">
                                        ...
                                        <input type="text" name="traveller_cardnum" id="friend_idCard" required="required" value="${param.cardnum}">
                                    </li>

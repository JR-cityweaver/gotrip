...
<body>
	 <div class="hotelOrder">
         ...
         <ul class="state clearfix">
             ...
             <li url="/hotelNew/orders.html?status=1"><a href="<%=basePath%>/hotel_iframe/hotelOrderIframe-1.jsp" target="content">待付款<sup id="hotelOrderNumberNoPay">${typeCount}</sup></a></li>
             <li url="/hotelNew/orders.html?status=2"><a href="<%=basePath%>/hotel_iframe/hotelOrderIframe-2.jsp" target="content">待出行<sup id="hotelOrderNumberPay"></sup></a></li>
         </ul>
         <div class="orders">
             <ul id="">
                  <!--加载订单内容-->
             ...
             <iframe name="content" style="width: 860px;height: 800px;border: 0px;" scrolling="no" src="<%=basePath%>/orderlist.do?pageNo=1"></iframe>
             <iframe name="content" style="width: 860px;height: 800px;border: 0px;" scrolling="no"></iframe>
         </div>
    </div>
</body>
</html>
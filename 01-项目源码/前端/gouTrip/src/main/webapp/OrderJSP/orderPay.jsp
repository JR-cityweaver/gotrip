 ...
 <!--主题订单 开始-->
                    <div class="themeOrder clearfix" >
                        ...
                        <ul class="state clearfix ">
                            <li ><a href="<%=basePath%>/order/getAllOrder.do?pageno=1" class="addd">全部订单<sup id="routeOrderNumberAll"></sup></a></li>
                                ...
                                <div class="all tab clearfix list_show">
                                    <!--主题所有订单-->
				                           ...
				                           <div class="clearfix list_show" id="ordersListAll" >		<ol>
											        <li>
											            <p title="豪华海景亲子大床房">${order.order_title }全部订单</p>
											        ...
											        <li>有效</li>
											        <li>
											        		<a href="http://www.goutrip.com/hotel/orders/20170626120840349938.html">查看</a>									        		
											        </li>
											    </ol>
					    					</div>
					    					</c:forEach>

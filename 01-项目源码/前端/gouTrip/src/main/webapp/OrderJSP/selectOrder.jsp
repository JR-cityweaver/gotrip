...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <%-- <script src="<%=basePath%>/routeOrderSubmit/hm.js"></script><script src="<%=basePath%>/routeOrderSubmit/jquery-1.11.3.js"></script>
    <script src="<%=basePath%>/routeOrderSubmit/layer.js"></script><link rel="stylesheet" href="<%=basePath%>/routeOrderSubmit/layer.css" id="layui_layer_skinlayercss"> --%>
</head>
<body>
	<!--头部开始-->
	<!--顶部导航开始-->
<div class="header">
    <div class="clearfix w1200">
                <ol class="head-nav fl">
                    <li class="logo"><a href="<%=basePath%>/home.jsp"><img src="<%=basePath%>/image/logo.png"></a></li>
		        ...
		        <c:if test="${userSession.user_phone == null}">
			        <div class="signOut">
			            <img src="<%=basePath%>/image/personal.png">
			            <span>
...
<!--意见反馈开始-->
		...
		<!--意见反馈结束-->
<%-- <script src="<%=basePath%>/routeOrderSubmit/jquery.lazyload.min.js"></script><!--懒加载图片-->
            		...
            		<div class="inner_1">
		                ...
		                <div class="container">
		                    ...
		                    <div class="col">
		                        ...
		                        <p>${tourist.tourist_card}</p>
		                        <p>${tourist.tourist_cardnum}</p>
		                        <p></p>
		                        <p></p>
		                        <p>${tourist.tourist_country}</p>
		                        <p>${tourist.tourist_sex}</p>
		                        <p></p>
		                        <p>${tourist.tourist_tele}</p>
		                    </div>
		                </div>
		            </div>
